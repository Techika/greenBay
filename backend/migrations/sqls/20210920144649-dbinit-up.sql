...
CREATE TABLE IF NOT EXISTS `greenbay`.`sellable` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `min-price` INT UNSIGNED NULL,
  `max-price` INT UNSIGNED NULL,
  `sell-price` INT UNSIGNED NULL,
  `posted-at` INT UNSIGNED NOT NULL,
  `posted-until` INT UNSIGNED NULL,
  `sold-at` INT UNSIGNED NULL,
  `price-type` VARCHAR(45) NOT NULL,
  `status` VARCHAR(45) NOT NULL,
  `seller_id` INT UNSIGNED NOT NULL,
  `buyer_id` INT UNSIGNED NULL,
  `title` VARCHAR(45) NOT NULL,
  `description` VARCHAR(255) NULL,
  `photo-url` VARCHAR(255) NULL,
